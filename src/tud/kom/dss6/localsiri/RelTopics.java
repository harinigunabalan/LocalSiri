...
public class RelTopics  extends ListActivity {
	
	List<Topic> topicList;
	protected ListView listview;
	Topic topic;
	LocalSiriApplication lsApplication;
	public final String CLASS_NAME = "RelatedTopics";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rel_topics); 
        
     
        listview = (ListView) findViewById(R.id.listRelTopics);
		...
		progressDialog = ProgressDialog.show(this,
                "Please Wait",
                "Loading your Topics", true, false);
...
/*    		
                    ...
                    if (task.isCancelled()){
					 ...
					 // If the result succeeds, load the list.
				        ...
				        if(!topicList.isEmpty()){	
				        	...
				        	ArrayAdapter<Topic> adapter = new ArrayAdapter<Topic>(RelTopics.this, 
				        ...
				        {
				        	progressDialog.dismiss();
				            	Toast.makeText(RelTopics.this, "No Data available to display",
    ...
    public void checkIfRelevant(Topic topic){
